...
class Ui_Dialog(object):
    def setupUi(self,Dialog):
        ...
        self.cmpCodigo.setMaxLength(6)
        self.cmpCodigo.setValidator(QIntValidator())
        self.cmpCodigo.setStyleSheet("QLineEdit { background-color : white; color : black; }")
        ...
        #Botão Radio para pessoa física e juridica
